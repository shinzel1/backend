...
<body class="container py-4">
    ...
    <form method="post" class="row g-3">
        ...
        <div class="col-12">
            ...
            <textarea name="content" id="editor"><?= htmlspecialchars($blog['content'], ENT_QUOTES | ENT_SUBSTITUTE) ?></textarea>
        </div>

        <div class="col-12">
            <button type="submit" class="btn btn-primary">Update Blog</button>
            <a href="admin-blogs.php" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
